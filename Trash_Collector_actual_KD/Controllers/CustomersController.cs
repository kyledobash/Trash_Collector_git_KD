...
namespace Trash_Collector_actual_KD.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Address,ZipCode,State,Balance,WeeklyPickupDay,OneTimePickup,StartSuspendService,EndSuspendService")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
